        ...
        <div class="col-md-8">
            ...
            <div class="panel panel-inverse" data-sortable-id="form-stuff-3">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">Adicionar Departamento</h4>
                </div>
                <div class="panel-body">
                    <form action="<?php echo URL?>departamento/salvar" method="POST" data-parsley-validate="true" class="form-cad-departamento">
                        <fieldset>
