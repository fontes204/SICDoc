        ...
        <div class="col-md-12 col-sm-6">
            <div class="widget widget-stats bg-blue">
                ...
                <div class="stats-info">
                    <p><i class="fa fa-edit"></i> Alterar Credênciais</p>
                    <h4>&nbsp;</h4>
                </div>
            </div>
        </div>
                                ...
                                <form action="<?php echo URL?>authentication/verificarSenha" method="post" class="frm-verifcar-senha">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" class="id_usuario" name="id_usuario" value="<? echo $idUtilizador?>">
                                            <input type="hidden" class="id_usuario" name="user" value="<? echo $dadosC->_utilizador?>">
                                        </div>
