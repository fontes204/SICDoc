...
<!--                <button type="button" class="close btn-refresh" data-dismiss="modal" aria-hidden="true">×</button>-->
            ...
            <div class="modal-body">
                <p class="text-center "><strong>Por razões de segurança aconselhamos-te a trocar as tuas credeências de acesso ao sistema.</strong></p>
                <p class="text-center">
                    <a href="<?php echo URL.$att->getController()?>/alterarCredenciais/<?php echo base64_encode(Session::get('id_user'))?>" class="btn btn-warning btn-xs m-r-5 btn-alterar-cred" >Alterar Agora</a>
                    <a href="javascript:;" class="btn btn-default btn-xs btn-adiar-cred" data-dismiss="modal">Próxima véz</a>
                </p>
            </div>
            <div class="modal-footer">
...
<div class="modal fade calback-sucesso" id="modal-conta-criada">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
...
<div class="modal fade" id="modal-eliminar-editar">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h6 class="modal-title"><i class="fa fa-search"></i> Informe um termo para a pesquisa</h6>
            </div>
            <div class="modal-body">
                <div class="form-group blockNome">
                    <input type="text" name="nome" value="" autofocus placeholder="Sua pesquisa aqui" data-parsley-required="true" class="form-control input-lg termo-pesquisa" required />
                    <span class="error-nome"></span>
                </div>
<!--                <p class="f-s-13 text-inverse">É realmente um ponto fronteiriço?</p>-->
                <div class="row">
                    <div class="col-md-2"></div>
                    <div class="col-md-8 col-lg-push-1">
                <div class="vertical-box-column">
                    <!-- begin list-email -->
                    <ul class="list-group list-group-lg no-radius list-email1"></ul>
                </div>
                    </div>
                    <div class="col-md-2">
                    <!-- end list-email --></div>
